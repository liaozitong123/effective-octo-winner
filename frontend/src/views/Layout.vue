      ...
      <el-aside :width="asideWidth" class="sidebar">
        ...
        >
          ...
          <el-sub-menu index="finance">
            ...
            <el-menu-item index="/finance/daily-expenses">日常支出费用表</el-menu-item>
...
const pageTitle = computed(() => {
  ...
  const m = {
    ...
    '/finance/receivables': '应收款', '/finance/payables': '应付款', '/finance/salary': '工资表',
    '/finance/daily-expenses': '日常支出费用表', '/finance/profit': '利润分析',
  }
  return m[route.path] || ''
})
